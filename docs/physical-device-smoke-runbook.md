...
| Proof media scan rejection | A server or mock `PROOF_MEDIA_REJECTED` upload response shows recapture guidance without queuing that photo as retryable proof. | Rejected proof media becomes durable evidence or remains in the retry queue. |
